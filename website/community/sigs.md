...
sidebar_label: "SIGs"
sidebar_position: 6
description: "Special Interest Groups (SIGs) — llm-d community"
custom_edit_url: https://github.com/llm-d/llm-d/edit/main/SIGS.md
---

:::info
This page mirrors [`SIGS.md`](https://github.com/llm-d/llm-d/blob/main/SIGS.md) from the llm-d repository. Edit it there.
:::
...
SIGs operate within the broader llm-d project governance framework defined in [PROJECT.md](https://github.com/llm-d/llm-d/blob/main/PROJECT.md):
...
- All SIG work follows the project's [contribution guidelines](/community/contribute)
...
3. **Proposal process**: Submit proposal following [project contribution guidelines](/community/contribute)
...
- **Community Governance**: [PROJECT.md](https://github.com/llm-d/llm-d/blob/main/PROJECT.md)
- **Contributing Guidelines**: [CONTRIBUTING.md](/community/contribute)
