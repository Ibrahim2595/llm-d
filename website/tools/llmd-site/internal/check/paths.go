...
func internalPathCandidates(path string) []string {
	...
	// Root-absolute doc paths from dev docs pages resolve under /docs/ or /docs/dev/.
	for _, prefix := range []string{
		"/architecture/", "/getting-started/", "/how-to-guides/",
		"/well-lit-paths/", "/operations/", "/infrastructure/",
		"/api-reference/", "/accelerators/",
	} {
